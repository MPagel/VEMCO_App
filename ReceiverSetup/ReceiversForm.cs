...
namespace ReceiverSetup
{
    public partial class ReceiversForm : Form
    {
        ...
        private void ReceiversGridView_CellMouseClicked(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if (e.RowIndex != -1) 
            {
                ReceiversGridView.SelectedRows[0].Cells[1].Style.SelectionForeColor = ReceiversGridView.SelectedRows[0].Cells[1].Style.SelectionBackColor;
        ...
        //Changes color of each 'Status' cell on databinding completion
